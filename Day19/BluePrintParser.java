...
class BlueprintsParser {
  ...
  private static Blueprint parseBlueprint(String input) {
    ...
    Resources oreRobotCost = Resources.builder().with(ResourceType.ORE, oreRobotCostOre).build();

    int clayRobotCostOre = Integer.parseInt(matcher.group(3));
    Resources clayRobotCost = Resources.builder().with(ResourceType.ORE, clayRobotCostOre).build();
    ...
    Resources obsidianRobotCost =
        Resources.builder()
            .with(ResourceType.ORE, obsidianRobotCostOre)
            .with(ResourceType.CLAY, obsidianRobotCostClay)
            .build();
    ...
    Resources geodeRobotCost =
        Resources.builder()
            .with(ResourceType.ORE, geodeRobotCostOre)
            .with(ResourceType.OBSIDIAN, geodeRobotCostObsidian)
            .build();
